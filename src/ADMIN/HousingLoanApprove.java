...
public class HousingLoanApprove extends javax.swing.JFrame {
    ...
    private void loadHouseLoanDetails() {
        try 
        {
          ...
          // ResultSet rs = new Dbcon().select("SELECT user_details.name AS user_name, user_details.user_id AS user_id, house_loan.* FROM house_loan ,user_details WHERE house_loan.loan_status=0 AND house_loan.user_id = user_details.user_id and user_details.name like '%" + name + "%'");
             ResultSet rs1=new Dbcon().select("Select user_details.*,house_loan.* from user_details,house_loan where house_loan.loan_status=0 AND house_loan.user_id=user_details.user_id and user_details.name like'%"+name+"%'");
            ...
            while (rs1.next())
            {
                ...
                count++;
                 String loanId = rs1.getString("house_id");
                ...
                String income=rs1.getString("annual_income");
                String loadAmountRequired = rs1.getString("loan_amount");               
                String tenrure = rs1.getString("tenure");
                 String interest = rs1.getString("interst");
                //String appliedDate = rs.getString("created_at");
                String status = "Pending";

                String row[] = new String[]{count + "",loanId, user_name, purpose,district,place,email,mobile,occupation,income, loadAmountRequired,tenrure,interest /*SharedServices.convertDate(appliedDate)*/, status};
                model.addRow(row);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sl.No", "App.No", "Name", "purpose", "District", "place", "Email", "Mobile", "Occupation", "Income", "Applied Amtt", "Tenure", "interst", "Status"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        ViewHousingLoanDoc documents = new ViewHousingLoanDoc(selectedLoanId, requestedAmount,tenure,interest);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        requestedAmount = jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 10).toString();
        tenure = jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 11).toString();
        interest = jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 12).toString();
