...
public class ChitApprovel extends javax.swing.JFrame {
    ...
    private void loadChittiApprovals() {
        try {
            ...
            String query = "SELECT user_details.*,chitti_apply.* FROM chitti_apply, user_details WHERE STATUS = 0 AND user_details.user_id = chitti_apply.user_id and user_details.name like "
                    + " '%" + applicantName + "%' and "
                   + " chitti_apply.chit_name like '%" + chittiName + "%' "
                   + " ";
          //  String query="SELECT chittis.*,chitti_apply.* from chittis,chitti_apply WHERE STATUS=0 and chitti_apply.chitti_id=chittis.id like "
           //+ " '%" + applicantName + "%' and "
           // + "chitti_apply.chit_name like '%"+chittiName +"' "
              //      + " ";
            ...
            while (rs.next()) 
            {
                ...
                count++;
                String app_no=rs.getString("chit_app_id");
               ...
               // String chitti_id = rs.getString("chitti_id");
                //String install_amount=rs.getString("subscription_amount");
                //String no_installment=rs.getString("no_of_installments");
               ...
               String row[] = new String[]{count + "", app_no,chit_name, user_name,district,place,mob,email,income,created_at,status};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SL.No", "App.No", "Chit Name", "user Name", "District", "Place", "Mobile", "Email", "income", "Applied date", "Status"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ViewChitDoc doc = new ViewChitDoc(chit_app_id);
        doc.setVisible(true);
        this.dispose();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try 
        {
            //chit_app_id = Integer.parseInt(jTable1.getModel().getValueAt(jTable1.getSelectedRow(),7).toString());
             chit_app_id = Integer.parseInt(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 1).toString());
