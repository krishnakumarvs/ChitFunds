   ...
   // String selectedChit;
    ...
    public Auction() 
    {
      ...
      private void loadChits() {
        try {
            ...
            ResultSet rs = new Dbcon().select("select * from chittis where chit_name like '%" + jTextField2.getText() + "%'");
            ...
            while (rs.next()) {
               ...
               // String amount = rs.getString("amount");
                String subscribers=rs.getString("no_of_installments");
                String date=rs.getString("auction_date");
              //  String subscription_amount = rs.getString(a);
               // String no_of_installments = rs.getString("no_of_installments");

                String row[] = new String[]{count + "", id,chitName, subscribers,shared.SharedServices.convertDate(date)};
                model.addRow(row);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sl.No", "Chit No", "Chit Name", "Subscribers", "Date"
            }
        ) {
        ...
        jButton5.setText("Start Auction");
...
// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:  
        AuctionProcess process = new AuctionProcess(select_chit_id);
        process.setVisible(true);
        dispose();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try
        {
          select_chit_id = Integer.parseInt(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 1).toString());
        ...
        catch(Exception e)
        {
         ...
         //selectedChit = Integer.parseInt(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 1).toString());
