...
public class GoldLoanApprove extends javax.swing.JFrame {
    String selectedLoanId, requestedAmount,goldweight,max_poss_amt;
    ...
    private void loadGoldLoanDetails() {
        ...
        try {
            ...
            ResultSet rs = new Dbcon().select("SELECT user_details.*, gold_loan.* FROM gold_loan ,user_details WHERE gold_loan.status=0 AND gold_loan.user_id = user_details.user_id and user_details.name like '%" + jTextField2.getText() + "%'");
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            int count = 0;
            while (rs.next()) {

                count++;
                String loanId = rs.getString("gold_id");
               ...
               // String statusString = SharedServices.getOrderStatusMessage(status);
                   // SharedServices.convertDate(appliedDate)
                String row[] = new String[]{count + "", loanId, user_name,district,place,
                mobile, email,occupation,income,status};
                model.addRow(row);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sl.No", "App.No", "Name", "District", "place", "Mobile", "Email", "Occupation", "Income", "Status"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        ViewGoldLoanDoc doc=new ViewGoldLoanDoc(selectedLoanId);
        doc.setVisible(true);
        this.dispose();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        requestedAmount = jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 5).toString();
         ...
         goldweight = jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 1).toString();
       max_poss_amt = jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 5).toString();
