 ...
 * @author USER
 */
public class CarLoanCustomers extends javax.swing.JFrame {

    int app_id;
    /**
     * Creates new form CarLoanCustomers
     */
      public CarLoanCustomers() 
      {
         initComponents();
     ...
     //   String query2="SELECT user_details.*, car_loan.* FROM car_loan ,user_details WHERE car_loan.status=1 AND car_loan.user_id = user_details.user_id and user_details.name like '%" + jTextField2.getText() + "%' and user_details.user_id like '%"+jTextField1.getText()+"%'";
             
          String query="SELECT user_details.name AS user_name, user_details.user_id AS user_id, user_details.place as place,user_details.mobile as mobile, car_loan.* FROM car_loan ,user_details WHERE car_loan.status=1 and user_details.user_id=car_loan.user_id and user_details.name like"
                 + " '%" +username + "%'"
                  + " ";
            ...
            while (rs.next()) 
            {
                count++;
                 ...
                 String row[] = new String[]{count + "", app_no, user_name,place,mobile};
                model.addRow(row);
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        carloan_cus_Details details=new carloan_cus_Details(app_id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarLoanCustomers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarLoanCustomers().setVisible(true);
            }
        });
    }
