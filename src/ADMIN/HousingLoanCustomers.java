...
public class HousingLoanCustomers extends javax.swing.JFrame {
        ...
        try {
          ...
          //   String id = jTextField1.getText().trim();
           ...
           // jButton2.setEnabled(false);
                 ...
                 // String query="SELECT user_details.*,house_loan.* FROM  user_details,house_loan WHERE house_loan.loan_status = 1 AND  house_loan.user_id like "
                  // + " '%" + id + "%' and house_loan.user_name like "  
                 //  +" '%" +username+"%'"
                  //+ " ";
            
            
            
          String query="SELECT user_details.name AS user_name, user_details.user_id AS user_id, user_details.place as place,user_details.mobile as mobile, house_loan.* FROM house_loan ,user_details WHERE house_loan.loan_status=1 and user_details.user_id=house_loan.user_id and user_details.name like"
                 + " '%" +username + "%'"
                  + " ";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sl.No", "User Id", "Name", "Place", "Mobile"
            }
        ) {
        ...
        jButton4.setText("Click For More Deatsils");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        Loan_customer_Details customer=new Loan_customer_Details(app_id);
