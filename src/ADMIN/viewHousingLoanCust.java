 ...
 * @author USER
 */
public class viewHousingLoanCust extends javax.swing.JFrame {

    /**
     * Creates new form viewHousingLoanCust
     */
    public viewHousingLoanCust() {
        initComponents();
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewHousingLoanCust.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewHousingLoanCust().setVisible(true);
            }
        });
    }
