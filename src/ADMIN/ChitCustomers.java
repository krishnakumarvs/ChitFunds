 ...
 * @author USER
 */
public class ChitCustomers extends javax.swing.JFrame {

    /**
     * Creates new form ChitCustomers
     */
    public ChitCustomers() {
        initComponents();
        loadChitDetails();
    }
       private void loadChitDetails()
       {
        try
        {
            ...
            String chit_name = jTextField1.getText().trim();
            String username=jTextField3.getText().trim();
         
          
        //String query2="SELECT user_details.*,chittia_apply.*, FROM user_details,chitti_apply WHERE chitti_apply.status=1 AND chitti_apply.user_id = user_details.user_id and user_details.name like '%" + jTextField3.getText() + "%' and chitti_apply.chit_name like '%"+jTextField1.getText()+"%'";
        // String query2="SELECT user_details.*, chitti_apply.* FROM user_details , chitti_apply WHERE chitti_apply.status=1 AND chitti_apply.user_id = user_details.user_id and chitti_apply.chit_name like '%"+jTextField1.getText()+"%' and user_details.user_id like '%"+jTextField1.getText()+"%'";
            
             String query1="SELECT user_details.name AS user_name, user_details.user_id AS user_id, user_details.place as place,user_details.mobile as mobile, chitti_apply.* FROM chitti_apply ,user_details WHERE chitti_apply.status=1 and user_details.user_id=chitti_apply.user_id and chitti_apply.user_name like"
                   
                      + " '%" + username+ "%' and chitti_apply.user_name like "  
                      +" '%" +chit_name+"%'"
                      + " ";
            ...
            while (rs.next()) 
            {
                ...
                String chitname=rs.getString("chit_name");
                 ...
                 String row[] = new String[]{count + "", app_no, name,chitname,place,mobile};
                model.addRow(row);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sl.No", "user_id", "Name", "Chit Name", "place", "Mobile No"
            }
        ) {
        ...
        jButton2.setText("Click here For More Details");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChitCustomers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChitCustomers().setVisible(true);
            }
        });
    }
