 ...
 * @author USER
 */
public class Loan_customer_Details extends javax.swing.JFrame {
      int app_id;

    /**
     * Creates new form Loan_customer_Details
     */
    public Loan_customer_Details() {
        initComponents();
     ...
     public Loan_customer_Details( int app_id) {
         this.app_id = app_id;
     ...
     private void loaddetails()
     {
         try
         {
           ResultSet rs = new Dbcon().select("select house_loan.*, user_details.* from house_loan,user_details where house_loan.user_id=user_details.user_id='"+app_id+"'");
           if (rs.next()) 
           {
                ...
                jTextArea1.setText(permanent_address);
                  ...
                  jTextField9.setText(occupation);
                   ...
                   jTextField11.setText(purpose);
                   
                   String loan_amount= rs.getString("sactioned_amount");
                   jTextField12.setText(loan_amount);
                   
                    String repayment= rs.getString("repayment");
                   jTextField13.setText(repayment);
                   
                   
                    String interest_rate= rs.getString("interest_rate");
                   jTextField14.setText(interest_rate);
                   
                    String sactioned_tenure= rs.getString("sactioned_tenure");
                   jTextField15.setText(sactioned_tenure);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Loan_customer_Details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Loan_customer_Details().setVisible(true);
            }
        });
    }
