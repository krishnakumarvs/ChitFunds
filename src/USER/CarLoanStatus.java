...
public class carloanstatus extends javax.swing.JFrame {
    ...
    private void loadRequestDetails() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String appliedAmount = rs.getString("req_loan_amount");
              ...
              String statusString = "Not verified";
                ...
                String arr [] = new String [] { Appno, appliedAmount, interest ,tenure, approvedAmount, statusString,remark};
                model.addRow(arr);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "App.no", "Appled Amount", "Interest", "Tenure(months)", "Sactioned Amount", "Satus", "Remark"
            }
        ) {
