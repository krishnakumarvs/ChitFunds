 ...
 * @author USER
 */
public class Compliant extends javax.swing.JFrame {

    /**
     * Creates new form Compliant
     */
    public Compliant() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String compliant=jTextArea1.getText();
        if(compliant.equals(""))
        {
            JOptionPane.showMessageDialog(rootPane,"Mandatory");
        }
        String query="insert into compliant(compliant)"+"values('"+ compliant+ "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Compliant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
